...
namespace ControlGastos.Servicios
{
    ...
    public class ServicioReportes: IServicioReportes
	{
        ...
        private (DateTime fechaInicio, DateTime fechaFin) GenerarFechaInicioYFin(int mes, int año)  // Esto es una tupla
        {
            ...
            if (mes <= 0 || mes > 12 || año <= 1900)
            {
                ...
                fechaInicio = new DateTime(hoy.Year, hoy.Month, hoy.Day);
            }
            else
            {
